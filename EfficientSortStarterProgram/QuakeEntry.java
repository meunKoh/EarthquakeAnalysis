...
public class QuakeEntry implements Comparable<QuakeEntry>{
	...
	public int compareTo(QuakeEntry loc) {
	    ...
	    //break ties by depth, from smallest (most negative) depth to largest depth.
	    int compare = Double.compare(magnitude, loc.getMagnitude());
	    if(compare == 0){
	        compare = Double.compare(depth, loc.getDepth());
	    }
	    return compare;
